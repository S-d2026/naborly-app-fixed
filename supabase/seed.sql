insert into public.posts (title, type, price, loc, parish, qty_total, qty_left, description, vendor, whatsapp, free, tracking, highlight)
values
...
insert into public.events (title, loc, date_text, host, whatsapp, description, price, featured)
values
